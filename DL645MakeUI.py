...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.menu_2.addAction(self.action_Energy)
        self.menu_2.addAction(self.action_Parm)
        self.menu_2.addAction(self.action_Curr)
        self.menu_2.addAction(self.action_Cuver)
        self.menu_2.addAction(self.action_FreezeDay)
        self.menu_2.addAction(self.action_FreezeMon)
        self.menu_2.addAction(self.action_SettlementDate)
        self.menu_2.addAction(self.action_MtrEvent)
        self.menu_2.addAction(self.action_TaskParm)
        self.menu_2.addAction(self.action_FileTrans)
        self.menu_2.addAction(self.action_CommParm)
        self.menu_2.addAction(self.action_ExParm)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.menu_2.setTitle(_translate("mainWindow", "数据项"))
